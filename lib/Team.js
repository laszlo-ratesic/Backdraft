    ...
    .prompt([
      {
        ...
        choices: [gradient.summer("Add an Engineer"), gradient.atlas("Add an Intern"), gradient.instagram(`Finish building ${this.manager.name}'s team of ${this.employeeCount}`)],
      },
    ])
    .then((menu) => {
      if (menu.choice === gradient.summer("Add an Engineer")) {
        this.addEngineer();
      }
      if (menu.choice === gradient.atlas("Add an Intern")) {
        this.addIntern();
      }
      if (menu.choice === gradient.instagram(`Finish building ${this.manager.name}'s team of ${this.employeeCount}`)) {
        this.exitProgram();
      }
    });
};
